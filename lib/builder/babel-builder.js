...
export default class BabelBuilder extends Builder {
  constructor (router) {
    ...
    if (this.extensions.length < 1 && this.router.options.dev) {
      throw new TypeError(`BabelBuilder can't handle any file extension of given Router`)
    }
  ...
  transform (filename) {
    ...
    const result = { exports, source: transformed }
